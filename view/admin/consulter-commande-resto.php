<?php
	...
	$d=$_SESSION['date_c'];
	$requete="SELECT * FROM commande_resto WHERE date LIKE '%$d%'";
	$resultat=$pdo->query($requete);

	 $nblmd=$pdo->prepare("SELECT SUM(pt) AS prix_total FROM commande_resto WHERE date LIKE '%$d%'");
     $nblmd->execute();
		...
		<div class="container col-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
						LISTE DES COMMANDES DU <?= $_SESSION['date_c'] ?> EFFECTUES AU SEIN DU RESTAURANT
					</div>	
