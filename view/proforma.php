            ...
            <div class="contenair col-md-6 col-xd-12 col-md-offset-3 " style="margin-top:50px;">
                ...
                <div class="row mb-4">
                    ...
                    <div><?= $userinfo['adresse'] ?></div>
                     ...
                     <hr>
                     <div class="col-sm-6">                     
                        <div> Client :<?= $_SESSION['cli']; ?></div>
                        <div> Date de Proforma:<?= date('d/m/y'); ?></div>
                        <div> N°Proforma:<?= $_SESSION['dk']; ?></div>
                    ...
                    <div class="panel-body">
                            <table class="table table-striped" >
                                ...
                                <tbody>
                                    ...
                                    <p style="font-weight: bold;">Montant Total:<?php echo $_SESSION['p']; ?><?= $userinfo['monaie'] ?></p><br>
