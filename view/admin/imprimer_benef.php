<?php 
    ...
    require_once('../../controller/select-detail-com2.php');
		...
		<div class="container col-12">
			<div class="panel panel-default">
					...
					<div class="panel-heading">
						DETAILS COMMANDES <?= $_GET['date1']." " ?> AU  <?= $_GET['date2']." " ?>
					</div>
                                      ...
                                      <thead>
                                        ...
                                        <tfoot>
                                            <tr>
                                            	...
                                            	<th></th>
                                            	<th><?php 
                                                    $nblmd=$pdo->prepare("SELECT SUM(qte_com) AS prix_total FROM detail_commande WHERE date>='$id1' AND date<='$id2' ORDER BY date");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?></th>
                                                <th><?php 
                                                    $nblmd=$pdo->prepare("SELECT SUM(prix) AS prix_total FROM detail_commande WHERE date>='$id1' AND date<='$id2' ORDER BY date");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?><?= $userinfo['monaie'];?></th>
                                                <th><?php
                                                    ...
                                                    $nblmd=$pdo->prepare("SELECT SUM(pa) AS prix_total FROM detail_commande WHERE date>='$id1' AND date<='$id2' ORDER BY date");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?><?= $userinfo['monaie'];?></th>
                                                <th><?php
                                                    ...
                                                    $nblmd=$pdo->prepare("SELECT SUM(benef) AS prix_total FROM detail_commande WHERE date>='$id1' AND date<='$id2' ORDER BY date");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?><?= $userinfo['monaie'];?>
