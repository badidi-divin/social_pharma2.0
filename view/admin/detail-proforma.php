<?php
    ...
    require_once('../../controller/select-detail-proforma.php');
        ...
        <a href="commande2.php">Retour>>>></a>
                ...
                <div class="panel panel-default">
                   ...
                   <div class="panel-heading">
                        DETAILS PROFORMAS<a onclick="window.print();">ici</a>
                    </div>
                                      ...
                                      <thead>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th></th>
                                                <th><?php $id2=$_GET['id'];
                                                    $nblmd=$pdo->prepare("SELECT SUM(qte_com) AS prix_total FROM detail_proforma WHERE code='$id2'");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?></th>
                                                <th><?php $id2=$_GET['id'];
                                                    $nblmd=$pdo->prepare("SELECT SUM(prix) AS prix_total FROM detail_proforma WHERE code='$id2'");
                                                    $nblmd->execute();
                                                    $nblmd=$nblmd->fetch()['prix_total'];
                                                    echo $nblmd;
                                                ?><?= $userinfo['monaie'];?></th>
