<?php 
    ...
    require_once('../controller/update-commande.php');
    $requser=$pdo->prepare("SELECT * FROM commande WHERE id=?");
    $requser->execute(array($_GET['id']));
    $userinfo9=$requser->fetch();
 ?>
 <!DOCTYPE html>
<html>
<head>
        ...
        <!-- Navigation -->
            <div class="container col-12">
                ...
                <div class="panel-body">
                    <form method="post" action="pannier.php?action=ajout&amp;l=<?=""?>&amp;q=1&amp;p=<?= 0 ?>&amp;red=<?= 0 ?>" class="form-inline">
                        <div class="form-group">
                            <select name="mot1" class="form-control">Choisissez
                                    <?php
                                        $ps=$pdo->prepare("SELECT * FROM stock");
                                        $ps->execute();
                                        ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <button type="submit" name="envoie"  class="btn btn-success">Editer la Commande</button>
                        </div>
                        </form>
                    </div>
                </div>  
